...
Deste modo é possível integrar outras frameworks e guias de estilo css para o site sem interferir com as normas e os estilos padrão usados no site. No exemplo que se segue demonstra-se como incorporar os estilos das frameworks [tailwind](https://tailwindcss.com/) e [tachyons](http://tachyons.io/) no site sem interferência nos estilos do css original transformando o css importado em objectos javascript em que as propriedades correspondem às classes do css importado.
